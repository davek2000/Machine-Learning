...
data_page = "https://www.transfermarkt.com/spieler-statistik/wertvollstespieler/marktwertetop?land_id=0&ausrichtung=Abwehr&spielerposition_id=alle&altersklasse=alle&jahrgang=0&kontinent_id=0&plus=1&page=20"
# Most valuable defenders - page 1
...
#df.to_csv('Defenders.csv',index=False,header=True)
df.to_csv('Defenders.csv',mode='a',index=False,header=False)